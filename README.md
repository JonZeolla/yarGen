...
3. Install all dependencies with `pip install scandir lxml naiveBayesClassifier pefile` (@twpDone reported that in case of errors try `pip install pefile` and `pip install scandir lxml naiveBayesClassifier`)
